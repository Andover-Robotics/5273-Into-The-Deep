...
public class Intake {
    ...
    private static final double FOURL_INTAKE = 0.25, FOURL_TRANSFER = 0.292777, FOURL_SURVEY = 0.6228;
    private static final double FOURR_INTAKE = 0.3633, FOURR_TRANSFER = 0.50444, FOURR_SURVEY = 0.1783;
