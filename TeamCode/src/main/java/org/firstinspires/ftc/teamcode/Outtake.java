...
public class Outtake {
    ...
    private static final double ARML_BUCKET = 0.81611, ARML_TRANSFER = 0.185, ARML_CLIP = .8755555;
    private static final double ARMR_BUCKET = 0.18055, ARMR_TRANSFER = 0.81167, ARMR_CLIP = 0.122277;
