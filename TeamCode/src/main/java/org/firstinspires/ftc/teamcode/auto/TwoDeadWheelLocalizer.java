...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1756.3564462862887; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 3304.011755855088; // x position of the perpendicular encoder (in tick units)
    }
